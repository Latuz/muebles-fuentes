    ...
    <footer className="bg-[#2C2416] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Fabricación de muebles a medida y servicios de tapicería. Calidad,
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              ...
              <li className="flex items-center space-x-2">
                ...
                <a
                  href="mailto:contacto@mueblesfuentes.cl"
                  className="hover:text-secondary transition-colors"
                >
                  contacto@mueblesfuentes.cl
                </a>
              </li>
              <li className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>
            &copy; {currentYear} Muebles Artesanales. Todos los derechos
            reservados.
          </p>
        </div>
      </div>
