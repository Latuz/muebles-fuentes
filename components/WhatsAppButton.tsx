...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="hidden md:block absolute right-full mr-3 bg-gray-900 text-white px-3 py-2 rounded-lg text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
