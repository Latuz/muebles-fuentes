  ...
  const services = [
    {
      ...
      description:
        'Diseñamos y fabricamos muebles únicos adaptados a tus necesidades y espacios.',
      icon: (
        <svg
          className="w-12 h-12"
          fill="none"
    ...
    },
    {
      title: 'Tapicería',
      description:
        'Renovamos y restauramos tus muebles con telas de alta calidad y acabados impecables.',
      icon: (
        <svg
          className="w-12 h-12"
          fill="none"
    ...
    },
    {
      title: 'Restauración',
      description:
        'Devolvemos la vida a tus muebles antiguos con técnicas tradicionales y modernas.',
      icon: (
        <svg
          className="w-12 h-12"
          fill="none"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                Creamos muebles únicos que transforman espacios. Calidad, diseño
                y atención personalizada en cada proyecto.
              </p>
            ...
            <div className="relative h-[400px] md:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt="Muebles artesanales de alta calidad"
                fill
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Ofrecemos soluciones completas para crear y renovar los muebles de
              tus sueños
            </p>
          </div>
